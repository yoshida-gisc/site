...
\textbf{Takahiro Yoshida} is an Assistant Professor (\emph{Kōshi}) at \href{https://www.csis.u-tokyo.ac.jp/}{Center for Spatial Information Science}, the University of Tokyo, Japan. The foundation of all his research interests is \textbf{Geographical Information Science}. His more specific interests are as follows:

\begin{enumerate}
\def\labelenumi{(\arabic{enumi})}
\tightlist
\item
  \textbf{Urban and Regional Analysis} based on spatial statistics, spatial econometrics, and remote sensing, and its combination with compositional data analysis,
\item
