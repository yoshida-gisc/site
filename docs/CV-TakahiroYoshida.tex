...
\item
  ...
  \emph{Note}: Published: November 2022; Issued: July 2024.
\item
...
\tightlist
\item
  Ryota Tsurumi, Takahiro Yoshida (2024)
  ...
  \end{itemize}
\item
  Adair Garrett, Katherine Ginensky, Xi Wang, Hina Ahmed, Jingyuan Shen, Takahiro Yoshida, Akito Murayama, Perry Pei-Ju Yang (2024)
  ...
  \end{itemize}
\item
  Jingyuan Shen, Xi Wang, Abdulrahman Alorabi, Takahiro Yoshida, Akito Murayama, Perry Pei-Ju Yang (2024)
  ...
  \end{itemize}
\item
  Yujiro Hirano, Takahiro Yoshida, Yoshiki Yamagata, Yukiko Yoshida (2024)
  Energy management simulation for a local energy supply system.
  \emph{Energy Proceedings}, accepted.
  DOI: issued soon.
  ...
  \end{itemize}
\item
  Haya Helmy, Perry P.J. Yang, Takahiro Yoshida, Akito Murayama, Amal Bogoreh, Ishwar Ramnarine (2023)
  ...
  DOI: 10.46855/energy-proceedings-11107 {[}\href{https://www.energy-proceedings.org/carbon-neutrality-architecting-and-new-age-visions-for-urban-areas-using-systems-design-canvas-ae-a-case-study-of-tokyo-nihonbashi/}{LINK}{]}
