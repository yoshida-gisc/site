...
\tightlist
\item
  \textbf{February 11, 2026 {[}Publication{]}} accepted a co-authored paper in \emph{Geographical Analysis}
\item
...
\item
  ...
  \emph{Geographical Analysis}, in press (accepted: February 11, 2026).
  DOI: in press {[}LINK{]}
\item
