...
\item
  ...
  \emph{Proceedings of the 11th International Conference on Geographic Information Science}, accepted.
  DOI: in press.

  \begin{itemize}
  \tightlist
  \item
    This paper will be presented at the 11th International Conference on Geographic Information Science (GIScience 2021), Online, September 27--30, 2021 (Originally planned: Poznan, Poland, September 15--18, 2020).
  \end{itemize}
\item
  Daisuke Murakami, Narumasa Tsutsumida, Takahiro Yoshida, Tomoki Nakaya (2021)
...
\item
  ...
  \textbf{\emph{Urban carbon mapping: Spatio-temporal detail visualization for CO2 emissions}}
  In Takuro Kobashi (eds.)
  \emph{Urban Decarbonization}, in press, TAIGA Publishing.
  {[}in Japanese{]} {[}LINK{]}
\item
